...
<body id="page-top">
        ...
        <div class="container">
            <div class="row ">
                <div class="card mb-3 col-sm-6 g-0">
                    <div class="row ">
                        <div class="col-lg-4">
                            <img src="img/fakhri.jpg'" class="img-fluid rounded-start" alt="...">
                        </div>
                        <div class="col-lg-8">
                            <div class="card-body">
                ...
                <div class="card mb-3 col-sm-6 g-0">
                    <div class="row">
                        <div class="col-lg-4">
                            <img src="img/dina.jpg'" class="img-fluid rounded-start" alt="...">
                        </div>
                        <div class="col-lg-8">
                            <div class="card-body">
    ...
    <!-- Signup-->
    <section class="signup-section" style="background-image: linear-gradient(to bottom, rgba(0, 0, 0, 0.1) 0%, rgba(0, 0, 0, 0.5) 75%, #000 100%), url('assets/img/bg-signup.jpg')" id="signup">
